...
class _ActiveTabState extends State<ActiveTab> {
  ...
  Widget build(BuildContext context) {
    return getAllActiveData.isEmpty  ? const Center(child: Text("No Data Found!"),): Container(
                                                      ...
                                                      children: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () async {
                                                            ...
                                                            Navigator.of(ctx).pop();
                                                            await Navigator.push(context, MaterialPageRoute(builder: (context) => const BottomNavBar(0)));
                                                          },
                                                          child: Container(
                                                            color: Colors.white,
                                                            padding: const EdgeInsets.all(14),
                               ...
                               builder: (ctx) => AlertDialog(
                                 ...
                                 title: Center(child: Column(
                                   children:  [
                                     ...
                                     Text("Are You Sure ?",style: FontTextStyle.poppinsS18W7redColor,),
                                   ],
                                 )),
                                 content:  Text("Cancel User: ${getAllActiveData[index].cUSNAME}",style: FontTextStyle.poppinsS16W4redColor,),
                                 actions: <Widget>[
                                     ...
                                     children: [
                                       ...
                                       TextButton(
                                         onPressed: () async {
                                           ...
                                           Navigator.of(ctx).pop();
                                            await Navigator.push(context, MaterialPageRoute(builder: (context) => BottomNavBar(0)));
                                         },
                                         child: Container(
                                           color: Colors.white,
                                           padding: const EdgeInsets.all(14),
