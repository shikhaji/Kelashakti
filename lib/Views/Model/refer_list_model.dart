class ReferListModel {
  int? status;
  String? message;
  List<ReferListData>? users;

  ReferListModel({this.status, this.message, this.users});
  ...
  ReferListModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['users'] != null) {
      ...
      json['users'].forEach((v) {
        users!.add(new ReferListData.fromJson(v));
      });
    }
  }
...
class ReferListData {
  ...
  ReferListData.fromJson(Map<String, dynamic> json) {
