class SubmitedModel {
  int? status;
  List<SubmitedData>? message;

  SubmitedModel({this.status, this.message});

  SubmitedModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['message'] != null) {
      message = <SubmitedData>[];
      json['message'].forEach((v) {
        message!.add(new SubmitedData.fromJson(v));
      });
    }
  }
...
class SubmitedData {
  ...
  SubmitedData.fromJson(Map<String, dynamic> json) {
    cUSID = json['CUS_ID'];
    cUSTT = json['CUS_TT'];
